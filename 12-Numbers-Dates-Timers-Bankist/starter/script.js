...
// const pizzaTimer = setTimeout((ing1, ing2) => console.log(`here is the pizza with ${ing1} and ${ing2}`), 3000, ...ingredients)
// console.log('Waiting...');
...
//   const now = new Date();
//   console.log(new Intl.DateTimeFormat(undefined, optionss).format(now));
// }, 1500)